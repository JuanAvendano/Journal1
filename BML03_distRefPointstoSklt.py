...
def dist_ref_points_BML(n,k,save_info):
    # # ================================================================================================================
    # Inputs
    # # ================================================================================================================
    ...
    # 1. Paths arrangement
    # # ===============================================================================================================.
    # Name of the folder where the completeList_BML for the crack are located
    ...
    with open('completeList_BML_Crack ' + str(n) +'.txt') as f:
    ...
    points = [(y_coord, x_coord) for x_coord, y_coord, _, _, _ in CompleteList]
    ...
    if save_info == True:
        ...
        results_filename = "Points_for_results_BML.txt"
        with open(pathresult + '//' + results_filename, "w") as output:
...
#         dist_ref_points_BML(i, k, save_info)
