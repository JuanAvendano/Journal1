...
def dist_ref_points_BME(n,k,save_info):
    # # ================================================================================================================
    # Inputs
    # # ================================================================================================================
    ...
    # 1. Paths arrangement
    # # ===============================================================================================================.
    # Name of the folder where the completeList_BME for the crack are located
    pathsBME = path+'\BME\Crack ' + str(n) + '\\k=' + str(method_threshold) + '\\'
    ...
    with open('BME_completeList_Crack' + str(n) +' full_subimg.txt') as f:
    ...
    if save_info == True:
        ...
        results_filename = "Points_for_results_BME.txt"
...
for x in listk:
    ...
    for i in range(start, end + 1):
        dist_ref_points_BME(i, k, save_info)
