...
def Statistics(k,save_info,start,end):
    ...
    for n in range(start, end+1):
        ...
        pathsBML = path + '\BML\Crack ' + str(n) + '\\k=' + str(method_threshold) + '\\'
        ...
        points_filename = os.path.join(pathsBML, 'Points_for_results_BML.txt')
    ...
    if save_info == True:
        ...
        results_filename = 'BML_Full_List_Results MAD k=' + str(method_threshold)+'.txt'
        # Columns names
