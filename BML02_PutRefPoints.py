...
def PutRefPointsBML(n,k,horizontal,saveimg,saveref_points_list):
    # # ================================================================================================================
    # Inputs
    # # ================================================================================================================
    # Crack to check
    ...
    pathsBML = r'C:\Users\jcac\OneDrive - KTH\Journals\01-Quantification\Image_list\BML\Crack ' + str(n) + '\\k='+ str(method_threshold)+'\\'
    ...
    # # ==============================================================================================================..
    #Load final subimg
    final_img = cv2.imread(pathsBML+'finalImgCrack '+str(n)+'.png')
    # Transformation from BGR color code to RGB
    ...
    if save_img:
        ...
        dict.imgSaving(pathsBML, 'finalimg_marked_BML', final_img)
...
#         horizontal = False
#     PutRefPointsBML(i, k, horizontal, save_img, saveref_points_list)
